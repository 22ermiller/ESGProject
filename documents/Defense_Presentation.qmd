...
![](www/ESG_diagram.png){fig-align="center"}
...
![](www/ESG_structure_models_transparent.png){.absolute bottom="70" right="-200" width="700"}

## Wage Inflation Model Selection {.smaller background-color="#FFFAEE"}

![](www/eci_diagram.png){.absolute top="0" right="-100" width="400"}

1.  Explore Relationship between CPI and ECI

![](www/eci_cpi_plot.png)
...
<img src="www/sample_yield_curve.png" style="width: 100%; height: auto;"/>
:::
...
![](www/sim_results.png){fig-align="center"}

## Results (10,000 Simulations) {background-color="#FFFAEE"}

![](www/sim_results_zoomed.png){fig-align="center"}
...
```{=html}
<video class="fragment fade-up" data-fragment-index="3" src="www/app_example.webm" loop muted playsinline onloadedmetadata="this.playbackRate = 1.75;" ontransitionend="this.play();" style="
    position: absolute;
    bottom: 40px;
    right: 40px;
    width: 750px;
